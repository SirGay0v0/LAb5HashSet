...
public interface executeScript {
    static void script(Path pathScript, Path pathCollection, String scriptName, HashSet<Vehicle> hashset, Date date, boolean defender) throws IOException {
        ...
        try {
            while (!((line = buff.readLine()).equals("exit"))) {
                ...
                switch (line) {
                    ...
                    case "add":
                        ...
                        addVehicle.setCapacity(Integer.parseInt(buff.readLine()));
                    ...
                    case "update id":
                        ...
                        updateVehicle.setCapacity(Integer.parseInt(buff.readLine()));
                    ...
                    case "add_if_max":
                        ...
                        if (variableNumber > maxCapacityHashset) {
                            ...
                            vehicleMaxCapacity.setCapacity(Integer.parseInt(buff.readLine()));
                    ...
                    case "add_if_min":
                        ...
                        if (minCapacityHashset < variableNumber) {
                            ...
                            vehicleMinCapacity.setCapacity(Integer.parseInt(buff.readLine()));
            ...
            System.out.println("В скрипте допущена ошибка (линия "+ lineCounter+") - неверный тип/значение атрибута. Дальнейшее выполнение прекращено." );
        }
    }
}
